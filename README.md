...
- **Focused window border**: A configurable outline around the active managed window, amber by default. Keys `focused-window-border`, `focused-window-border-color`, `focused-window-border-width`.
